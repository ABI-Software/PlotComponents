...
If using vue 2, use the [Vue-2 branch](https://github.com/ABI-Software/plotcomponents/tree/Vue-2)

This project aims to process and display csv files as graphs in the vue framework

Demo the site functionality of this app [here](https://plotcomponents-demo.herokuapp.com/)*.
...
**Don't feel like coding? See how to copy and paste plotcomponents as an HTML widget [here](https://github.com/ABI-Software/plotcomponents/blob/master/README.md#copy-and-paste-as-an-html-widget)**
...
```javascript
import { plotcomponents } from '@abi-software/plotcomponents'
...
The snippet above registers the plotcomponents component into the global scope.
You can now use the plotcomponents in your vue template as followed:

```html
<plotcomponents :data-source="data" :metadata="metadata" :supplemental-data="supplementalData"></plotcomponents>
```

`datasource` has two options for loading data into plotcomponents:
...
`plotcomponents` will load and csv file that follow the form of headers on first row and coloumn and if data is time based, rows will be assumed to be time dependant.
...
```HTML
 ...
 <link href="https://cdn.jsdelivr.net/npm/@tehsurfer/plotcomponents-widget/dist/plotcomponents.css" rel="stylesheet">
 <!-- widget source js from cdn -->
 <script src="https://cdn.jsdelivr.net/npm/@tehsurfer/plotcomponents-widget/dist/plotcomponents.js"></script>
```
